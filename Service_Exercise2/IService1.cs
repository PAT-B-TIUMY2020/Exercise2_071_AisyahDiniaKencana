...
namespace Service_Exercise2
{
    ...
    public interface IService1
    {
        ...
        string UpdateMahasiswa(string nim, string nama);

       /* [OperationContract]
        [WebInvoke(Method = "COUNT", UriTemplate = "Mahasiswa", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        string CountMahasiswa(string nim, string nama);*/
        // TODO: Add your service operations here
    }

    // Use a data contract as illustrated in the sample below to add composite types to service operations.
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "Service_Exercise2.ContractType".
    [DataContract]
